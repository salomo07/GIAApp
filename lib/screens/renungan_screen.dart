...
class RenunganScreen extends StatefulWidget {
  const RenunganScreen({Key? key, this.animationController}) : super(key: key);
...
class _RenunganScreenState extends State<RenunganScreen> with TickerProviderStateMixin {
