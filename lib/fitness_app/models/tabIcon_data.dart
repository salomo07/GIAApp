...
class TabIconData {
  TabIconData({this.imagePath = '',this.index = 0,this.selectedImagePath = '',this.isSelected = false,this.animationController,this.label=""});
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    ...
    TabIconData(
      ...
      index: 2,
      isSelected: false,
      animationController: null,label:"Video"
    ),
    TabIconData(
      ...
      index: 3,
      isSelected: false,
      animationController: null,label:"Contact"
    ),
  ];
}
